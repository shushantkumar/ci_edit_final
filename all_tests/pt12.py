...
class pt12(unittest.TestCase):
    def testpt12(self):
        ...
        a = timeit(
            'data1 = data1[0][0][:500] + "x" + data1[0][0][500:]',
            setup='data1 = [["a" * 1000]*10]*10',
            number=10000)
        b = timeit(
            'data2[0][0][5] = data2[0][0][5][:50] + "x" + data2[0][0][5][50:]',
            setup='data2 = [[["a" * 100] * 10]*10]*10',
            number=10000)
        self.assertGreater(a, b *0.01)
        self.assertLess(a, b * 4)
        # At 10,000 bytes the array of strings is 1.4 to 3 times faster.
        a = timeit(
            'data1 = data1[0][0][:5000] + "x" + data1[0][0][5000:]',
            setup='data1 = [["a" * 10000]*10]*10',
            number=10000)
        b = timeit(
            'data2[0][0][50] = data2[0][0][50][:50] + "x" + data2[0][0][50][50:]',
            setup='data2 = [[["a" * 100] * 100]*10]*10',
            number=10000)
        self.assertGreater(a, b * 0.04)
        self.assertLess(a, b * 4)
        # At 100,000 bytes the array of strings is 12 to 24 times faster.
        a = timeit(
            'data1[0][0] = data1[0][0][:50000] + "x" + data1[0][0][50000:]',
            setup='data1 = [["a" * 100000]*10]*10',
            number=10000)
        b = timeit(
            'data2[0][0][500] = data2[0][0][500][:50] + "x" + data2[0][0][500][50:]',
            setup='data2 = [[["a" * 100] * 1000]*10]*10',
            number=10000)
